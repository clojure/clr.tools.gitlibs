...
(deftest test-procure
  (let [wt1 (gl/procure repo-url 'org.clojure/spec.alpha "739c1af")
    ...
    (is (.Exists (cio/dir-info (gl/cache-dir) "_repos" "https" "github.com" "clojure" "spec.alpha")))                                                  ;;; .exists jio/file
    (is (= wt1 (.FullName (cio/file-info (gl/cache-dir) "libs" "org.clojure" "spec.alpha" "739c1af56dae621aedf1bb282025a0d676eff713"))))                ;;; jio/file .getAbsolutePath 
    (is (= wt2 (.FullName (cio/file-info (gl/cache-dir) "libs" "org.clojure" "spec.alpha" "6a56327446c909db0d11ecf93a3c3d659b739be9"))))))              ;;; jio/file .getAbsolutePath 
